...
class DeviceConfigurationTest {
    ...
    private static final DeviceType type1 = DeviceType.builder().modelID("model1").manufacturerName("manu1").build();
    private static final DeviceType type2 = DeviceType.builder().modelID("model2").manufacturerName("manu1").build();
    private static final DeviceType type3 = DeviceType.builder().modelID("model1").manufacturerName("manu2").build();
